...
def analyze_with_chatgpt(image_path):
    ...
    try:
        ...
        prompt_text = (
            ...
            "Se um campo não estiver visível ou não puder ser determinado, deixe-o vazio. "
...
def analyze_with_ocr(image_path):
    ...
    try:
        ...
        # Isso pode ser feito com OpenCV, mas para manter a dependência mínima, faremos uma binarização simples
        # ou usaremos um limiar mais agressivo.
        img = img.point(lambda x: 0 if x < 150 else 255, "1") # Limiar ajustado para 150
        ...
        for file in files:
            if file and allowed_file(file.filename):
                ...
                if analysis_method == "chatgpt":
                    ...
                    if not dados or all(value == '' for key, value in dados.items() if key != 'Arquivo'): # Fallback se ChatGPT falhar ou retornar vazio
